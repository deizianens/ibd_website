	...
	echo "<table class='table table-striped condutor'>  
		...
		<tbody>
			<tr>
				...
				<td><input class='form-control condutor_search' type='text' placeholder='Idade'></td>
				<td><input class='form-control condutor_search' type='text' placeholder='País'></td>
				<td><input class='form-control condutor_search' type='text' placeholder='Gênero'></td>
			</tr>";
